<?php
/* !\class: LineClass
 *  \brief: Class for drawing a rectangle
...
class RectangleClass implements CommandInterface {
    private $x1;
    private $y1;
    private $x2;
    private $y2;
    ...
    public function validateParameters(){
        ...
        if($this->x2 <= $this->x1){
            return "The value of x2 isn't lower or equal than x1.\n";
        }
        ...
        if($this->y2 <= $this->y1){
            return "The value of y2 isn't lower or equal than y1.\n";
        }
        return "";
    }
